...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, icon, items }) => {
    return (
        <div className="p-8 rounded-xl border border-gray-200 bg-white shadow-sm transition-all transform group hover:bg-[#084C61] hover:text-white hover:scale-105 hover:shadow-lg">
