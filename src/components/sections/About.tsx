  ...
  <div className="bg-black/50 p-8 md:p-12 lg:px-16 lg:py-24">
    <div className="flex flex-col justify-center items-center text-center ltr:sm:text-left rtl:sm:text-right">
      ...
      <div className="mt-4 sm:mt-8">
        <a
          href="#"
          className="inline-block rounded-full bg-yellow-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-yellow-700 focus:ring-3 focus:ring-yellow-400 focus:outline-hidden"
        >
          Get Yours Today
        </a>
      </div>
